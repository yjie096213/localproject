...
public class ServiceTypeController {
    ...
    /**
     * @MethodName:   selectAllServiceType
     * @Description: TODO(描述这个方法的作用) 获取所有服务类型信息(非分页)
     * @Params:      [ServiceType]
     * @Return:      java.util.List<com.htinf.sm.model.ServiceType>
     * @DATE:        2021/7/3 11:10
     * @Author:      Administrator
    ...
    public ResultValue selectAllNoPage(@RequestBody ServiceType serviceType) {
        return ResultValue.success(serviceTypeService.selectAllNoPage(serviceType));
    }
